...
public class Exam03 {
	...
	public static void main(String[] args) {
		...
		-----------------------------------------------
		답 = ((numOfApples + sizeOfBucket) / sizeOfBucket);
		-----------------------------------------------
		...
		답 = (int)((5 / 9f *(fahrenheit - 32f))*100 + 0.5 ) / 100f;
		...
		-----------------------------------------------
		답 = (ch >= 'a' && ch <= 'z' )||(ch >= 'A'&& ch <= 'Z')|| (ch <= '9' &&ch >= '1')
		-----------------------------------------------
